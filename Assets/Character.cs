...
/// </summary>
public partial class Character : MonoBehaviour, iXlsToJsonAccessor
{
    [SerializeField]
    ...
    /// テーブルを取得
    /// </summary>
    public static Class_Character GetTable()
    {
        return table;
    }
    ...
    /// 新規行を追加. ID 自動生成
    /// </summary>
    public static void Add(Class_Character.Row row)
    {
        lastId = lastId + 1;
        row.ID = lastId;
    ...
    /// 行を更新
    /// </summary>
    public static void Update(Class_Character.Row row)
    {
        EditorUtility.SetDirty(table);
        AssetDatabase.SaveAssets();
    }
